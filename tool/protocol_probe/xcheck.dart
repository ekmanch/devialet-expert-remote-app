...
void main() {
  for (final db in [-40.0, -40.5, -41.0]) {
    print('vol $db pc=7 cc=7: ${hx(CommandPacket(packetCounter: 7, commandCounter: 7, payload: CommandPayloads.setVolume(db, maxDb: -15.0)).encode().sublist(0, 14))}');
  }
  for (final i in [0, 1, 2, 3, 4, 5, 9, 14, 16, 29]) {
