...
/// store (checklist 19).
HydratedSettings testHydrated({InMemorySettingsStore? store, AppSettings? initial}) =>
    HydratedSettings(store: store ?? InMemorySettingsStore(), initial: initial ?? AppSettings.defaults);
